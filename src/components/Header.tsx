...
export function Header() {
  ...
  return (
    ...
    >
      <nav className="mx-auto max-w-[1200px] px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 text-gray-500 hover:text-gray-900 hover:bg-gray-100"
            >
